...
<body class="app-background min-h-screen text-slate-800">
    <div class="mx-auto max-w-3xl p-8">
        ...
        <?php if (isset($_GET['validated'])): ?><div class="mb-6 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-700">Compte validé. Complétez maintenant le profil enseignant pour le rendre visible dans la liste des enseignants.</div><?php endif; ?>
